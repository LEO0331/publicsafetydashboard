...
這個資料夾保存可長期維護的專案脈絡，避免重要資訊只留在對話紀錄中。

- [架構](./architecture.zh-TW.md)：runtime 邊界、資料流、schema 與 API 權責。
- [技術選型與取捨](./tech-stack.zh-TW.md)：為什麼選擇 Next.js、SQLite、Python ingestion、Leaflet 與 Docker，以及替代方案的 tradeoff。
...
- [部署](./deployment.zh-TW.md)：GitHub Actions、Docker image 發布與持久化部署指南。
- [專案結構](./project-structure.zh-TW.md)：檔案放在哪裡，以及為什麼這樣放。
