...
export const dashboardCopy = {
  zh: {
    ...
    tableTab: "資料表",
    mapTab: "地圖",
    visibleRecords: (shown: number, total: number, page: number, totalPages: number) => (total ? `目前顯示 ${shown} / ${total} 筆，第 ${page} / ${totalPages} 頁` : "目前顯示 0 筆"),
    previousPage: "上一頁",
    nextPage: "下一頁",
    goToPageLabel: "跳至第",
    pageUnit: "頁",
  ...
  en: {
    ...
    tableTab: "Table",
    mapTab: "Map",
    visibleRecords: (shown: number, total: number, page: number, totalPages: number) => (total ? `Showing ${shown} of ${total} records, page ${page} of ${totalPages}` : "Showing 0 records"),
    previousPage: "Previous",
    nextPage: "Next",
    goToPageLabel: "Go to page",
    pageUnit: "",
    goToPageButton: "Go",
    pageInputLabel: "Enter page number",
...
export const adminCopy = {
  zh: {
    ...
    logsTitle: "解析紀錄",
    reviewTitle: "待檢查資料列",
    sourcesTitle: "公告修正／隱藏",
    noReviewRows: "目前沒有待人工檢查資料列。",
    hide: "隱藏",
    unhide: "取消隱藏",
    noLogs: "目前尚無匯入紀錄。",
  },
  en: {
    ...
    reviewTitle: "Rows Needing Review",
    sourcesTitle: "Source Correction / Hide",
    noReviewRows: "No rows currently need manual review.",
    hide: "Hide",
    unhide: "Unhide",
...
export const mapCopy = {
  zh: {
    ...
    noDate: "無日期",
    legendTitle: "圖例",
    legendGrouped: "圓點代表地點群組，不代表個人。",
    legendSize: "圓點越大代表事件數越多。",
    legendApproximate: "Demo 座標為近似路段位置，請以原始公告與主管機關資料為準。",
  },
  en: {
    title: "Location List",
    ...
    noDate: "No date",
    legendTitle: "Legend",
    legendGrouped: "Circles represent grouped locations, not individual people.",
    legendSize: "Larger circles mean more incidents.",
    legendApproximate: "Demo coordinates are approximate road locations; source announcements remain authoritative.",
  },
} as const;
