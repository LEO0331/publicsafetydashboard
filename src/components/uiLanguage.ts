...
export const adminCopy = {
  zh: {
    ...
    uploadFile: "上傳解析",
    geocodeTitle: "地圖座標產生",
    geocodeDescription: "將尚未定位的違規地點送至 Nominatim，結果會快取到資料庫。只傳送地點文字，不傳姓名或違規事實。",
    geocodeLimitPlaceholder: "最多地點數，可留空",
    geocodeDelayPlaceholder: "每筆延遲秒數，預設 1.1",
    startGeocode: "產生地圖座標",
    logsTitle: "解析紀錄",
    noLogs: "目前尚無匯入紀錄。",
  },
  en: {
    ...
    geocodeDescription: "Sends ungeocoded violation locations to Nominatim and caches results in the database. Only location text is sent, never names or violation facts.",
    geocodeLimitPlaceholder: "Maximum locations, optional",
    geocodeDelayPlaceholder: "Delay seconds per lookup, default 1.1",
